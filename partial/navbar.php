                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="category"><i class="fa fa-shopping-bag"></i> Thời trang</a></li>
                                <li><a href="#"><i class="fa fa-shopping-bag"></i> Đồ điện tử</a></li>
                                <li role="separator" class="divider"></li>
                                <li><a href="#">Bếp</a></li>
                                <li><a href="#">Nhà tắm</a></li>
                                <li role="separator" class="divider"></li>
                                <li><a href="#">Đồ dùng thông minh</a></li>
                            </ul>
                        </li>
                    </ul>
